defmodule LiveNxIREEWeb.CoreComponents.SwiftUI do
  @moduledoc """
  ...
  of the `LiveNxIREEWeb.CoreComponents` functions you should expect identical functionality for similarly named
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveNxIREEWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveNxIREEWeb.Gettext, "errors", msg, opts)
    end
  end
