defmodule LiveNxIREENative do
  ...
  import LiveNxIREEWeb, only: [verified_routes: 0]
  ...
  def live_view() do
    quote do
      use LiveViewNative.LiveView,
        ...
        layouts: [
          swiftui: {LiveNxIREEWeb.Layouts.SwiftUI, :app}
        ]
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([LiveNxIREEWeb, CoreComponents, plugin.module_suffix])
